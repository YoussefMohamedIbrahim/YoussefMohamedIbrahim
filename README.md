...
* ⚙️ **Tools & Tech:** CMake, pybind11, GitHub Actions, Linux, Simulink.
...
**Databases & Systems**
* **Farm Management Database System:** Designed a normalized relational schema (3NF) to accurately model inventory, financials, and operations across 15+ related tables with complex referential integrity constraints and SQL seeding scripts.
